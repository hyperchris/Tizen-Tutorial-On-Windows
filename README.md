...
- Enter IDE. **Warning!** Pay attention to the upper toolbar of the IDE's UI. There must be an button like this:![alt tag](https://github.com/hyperchris/Tizen-Tutorial-On-Windows/tree/master/img/button.png). If there's no such a button, please uninstall all the IDE and choose the second choice.
...
- Select the prject name in Project Explorer (On left side). Then click the Smart Run button ![alt tag](https://github.com/hyperchris/Tizen-Tutorial-On-Windows/tree/master/img/run.png).   
